...
def start_ddp_trainer(rank, config):
    ...
    # breakpoint()
    ray.init(num_gpus=num_gpus, num_cpus=num_cpus, object_store_memory=150 * 1024 * 1024 * 1024 if config.env.image_based else 16 * 1024 * 1024 * 1024) # 100 * 1024 * 1024 * 1024)
